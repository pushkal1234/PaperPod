...
// *approximate* progress (the backend doesn't stream step events yet), so the
// UI always feels alive even though timing is heuristic.
const STAGES = [
  { key: 'read', label: 'Reading your document', icon: FileText, until: 15 },
  { key: 'script', label: 'Writing the dialogue script', icon: Wand2, until: 55 },
  { key: 'audio', label: 'Synthesizing the audio', icon: AudioLines, until: Infinity },
];
